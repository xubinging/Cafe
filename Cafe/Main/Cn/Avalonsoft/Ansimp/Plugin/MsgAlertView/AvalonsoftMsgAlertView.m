...
#import "AvalonsoftMsgAlertView.h"
#import "Masonry.h"

// 主按钮字体颜色
#define MAIN_BUTTON_COLOR RGBA_GGCOLOR(30,144,255,100)
// 主按钮font
...
// 灰色线的颜色
#define LINE_COLOR RGBA_GGCOLOR(232,232,232,100)

static NSInteger const kButtonBeginTag = 1000;

@interface AvalonsoftMsgAlertView ()
...
@implementation AvalonsoftMsgAlertView
...
+ (instancetype)showWithTitle:(nullable NSString *)title content:(NSString *)content buttonTitles:(NSArray <NSString *> *)buttonTitles buttonClickedBlock:(nullable void (^)(NSInteger index))buttonClickedBlock {
    AvalonsoftMsgAlertView *alertView = [[AvalonsoftMsgAlertView alloc] initWithTitle:title content:content buttonTitles:buttonTitles buttonClickedBlock:buttonClickedBlock];
    ...
    // 入场动画
    alertView.alpha = 0;
    alertView.contentView.transform = CGAffineTransformScale(alertView.contentView.transform, 0.1, 0.1);
