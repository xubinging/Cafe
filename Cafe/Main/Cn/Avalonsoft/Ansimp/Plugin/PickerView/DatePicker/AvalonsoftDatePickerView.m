...
#import "AvalonsoftDatePickerView.h"

@interface AvalonsoftDatePickerView ()
{
    UIDatePickerMode _datePickerMode;
    AvalonsoftDateResultBlock _resultBlock;
    NSString *_title;
...
@implementation AvalonsoftDatePickerView
...
{
    AvalonsoftDatePickerView *datePickerView = [[AvalonsoftDatePickerView alloc] initWithTitle:title DateType:type DefaultSelValue:defaultSelValue MinDateStr:(NSString *)minDateStr MaxDateStr:(NSString *)maxDateStr IsAutoSelect:isAutoSelect ResultBlock:resultBlock Manager:nil];
...
{
    AvalonsoftDatePickerView *datePickerView = [[AvalonsoftDatePickerView alloc]initWithTitle:title DateType:type DefaultSelValue:defaultSelValue MinDateStr:(NSString *)minDateStr MaxDateStr:(NSString *)maxDateStr IsAutoSelect:isAutoSelect ResultBlock:resultBlock Manager:manager];
    [datePickerView showWithAnimation:YES];
}
...
- (UIDatePicker *)datePicker {
    if (!_datePicker) {
        ...
        // 设置该UIDatePicker的国际化Locale，UIDatePicker控件默认使用iOS系统的国际化Locale
        ...
        // 设置时区
        // [_dateP icker setTimeZone:[NSTimeZone localTimeZone]];
