...
@interface AvalonsoftPickerUIBaseView ()

@end

@implementation AvalonsoftPickerUIBaseView
...
- (AvalonsoftPickerViewManager *)manager
{
    if (!_manager ) {
        _manager = [AvalonsoftPickerViewManager new];
    }
    return _manager;
}
...
- (UIView *)topView {
    if (!_topView) {
        ...
        _topView.backgroundColor = RGBA_GGCOLOR(251, 249, 254, 1);
    }
    return _topView;
}
