...
@interface AvalonsoftTwoWaySlider : UIView
...
@property (strong, nonatomic, readonly) AvalonsoftTwoWaySliderIndicateView *minIndicateView;    //滑块指示视图
@property (strong, nonatomic, readonly) AvalonsoftTwoWaySliderIndicateView *maxIndicateView;    //滑块指示视图

/**
 初始化函数
 
 @param frame 位置 总体高度以滑块为底部开始布局 指示标的高度为24
 @param minValue 最小值
 @param maxValue 最大值
