...
@interface CMPhotoPreviewDoneButton : UIButton

@end

@protocol CMPhotoPreviewBottomBarDelegate <NSObject>
@optional
...
@interface CMPhotoPreviewBottomBar : UIView

@property (nonatomic, assign) NSInteger currentIndex;
@property (nonatomic, weak) id<CMPhotoPreviewBottomBarDelegate> delagate;
...
@interface CMPhotoPreviewBottomBarCell : UICollectionViewCell
