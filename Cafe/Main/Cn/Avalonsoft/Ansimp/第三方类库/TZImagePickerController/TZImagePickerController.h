...
/// 图片最大字节
@property(nonatomic, assign) NSInteger maxPhotoByte;
...
-(void)imagePickerControllerSelectedOverMax:(TZImagePickerController *)picker;
...
typedef void(^TZFAlbumTableViewEndAnimateBlock)(BOOL endAnimate);

@interface TZAlbumPickerView : UIView
@property (nonatomic , strong) TZImagePickerController *imagePickerVc;
@property (nonatomic, assign) NSInteger columnNumber;
@property (assign, nonatomic) BOOL isFirstAppear;
/// 选择的相册
@property (nonatomic, copy) TZFAlbumTableViewSelectAction selectAction;
@property (nonatomic, copy) TZFAlbumTableViewEndAnimateBlock endAnimateBlock;
- (void)configTableView;
/// 展示相册
+(void)showAlbumViewWithImagePickerVc:(TZImagePickerController *)imagePickerVc complete:(void(^)(TZAlbumModel *albumModel))complete hidenAlbumViewBlock:(void(^)(BOOL endAnimateBlock))hidenAlbumViewBlock;
@end
