...
UIKIT_EXTERN NSString * const MINE_MY_EXAM_SCORE_DELETE;
...
UIKIT_EXTERN NSString * const MINE_MY_ACTIVITY_LIST;
UIKIT_EXTERN NSString * const MINE_MY_ACTIVITY_DETAILS;
UIKIT_EXTERN NSString * const MINE_MY_ACTIVITY_ADD;
UIKIT_EXTERN NSString * const MINE_MY_ACTIVITY_UPDATE;
UIKIT_EXTERN NSString * const MINE_MY_WORK_LIST;
UIKIT_EXTERN NSString * const MINE_MY_WORK_DETAILS;
UIKIT_EXTERN NSString * const MINE_MY_WORK_ADD;
UIKIT_EXTERN NSString * const MINE_MY_WORK_UPDATE;
UIKIT_EXTERN NSString * const MINE_MY_OFFER_LIST;
UIKIT_EXTERN NSString * const MINE_MY_OFFER_DETAILS;
UIKIT_EXTERN NSString * const MINE_MY_OFFER_ADD;
UIKIT_EXTERN NSString * const MINE_MY_OFFER_UPDATE;
UIKIT_EXTERN NSString * const MINE_MY_OFFER_DELETE;
UIKIT_EXTERN NSString * const MINE_MY_LEARNING_LIST;
UIKIT_EXTERN NSString * const MINE_MY_LEARNING_DETAILS;
UIKIT_EXTERN NSString * const MINE_MY_LEARNING_ADD;
UIKIT_EXTERN NSString * const MINE_MY_LEARNING_UPDATE;
UIKIT_EXTERN NSString * const MINE_MY_LEARNING_DELETE;
UIKIT_EXTERN NSString * const MINE_MY_EDUCATION_LIST;
UIKIT_EXTERN NSString * const MINE_MY_EDUCATION_DETAILS;
UIKIT_EXTERN NSString * const MINE_MY_EDUCATION_ADD;
UIKIT_EXTERN NSString * const MINE_MY_EDUCATION_UPDATE;
UIKIT_EXTERN NSString * const MINE_MY_EDUCATION_DELETE;
UIKIT_EXTERN NSString * const MINE_MY_RECEIVE_REPLY_LIST;
UIKIT_EXTERN NSString * const MINE_MY_POST_REPLY_LIST;
UIKIT_EXTERN NSString * const MINE_MY_ABOARD_SELECT_LIST;
UIKIT_EXTERN NSString * const MINE_MY_INTERNAL_SELECT_LIST;
