//
//  MyLikeCooperateSchoolViewCell.m
//  Cafe
//
...
@implementation MyLikeCooperateSchoolViewCell
...
- (void)updateCellWithModel:(MyLikeCooperateSchoolModel *)model
{
    ...
    if (model.logo == NULL || [model.logo isEqualToString:@""]) {
        ...
        [_schoolIconImageView sd_setImageWithURL:[NSURL URLWithString:[_F createFileLoadUrl:model.logo]]];
    }
