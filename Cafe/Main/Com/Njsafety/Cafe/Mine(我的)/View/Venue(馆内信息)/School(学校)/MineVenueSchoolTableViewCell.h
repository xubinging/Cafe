//
//  MineVenueSchoolTableViewCell.h
//  Cafe
//
...
@interface MineVenueSchoolTableViewCell : UITableViewCell
...
@property (nonatomic, strong) UILabel *schoolNameChLabel;

@property (nonatomic, strong) UILabel *schoolNameEnLabel;
