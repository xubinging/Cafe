//
//  MineSkillDetailViewController.m
//  Cafe
//
...
#import "MineSkillDetailViewController.h"
...

{
    ...
    @private MineSkillModel *slctModel;
}
...
@implementation MineSkillDetailViewController
...
-(void)rightButtonClick
{
    ...
    if (slctModel.skillDesc) {
        [sendDic setValue:slctModel.skillDesc forKey:@"name"];
    }
    if (slctModel.skillDate) {
        [sendDic setValue:slctModel.skillDate forKey:@"date"];
    }
            ...
            [[AvalonsoftHttpClient avalonsoftHttpClient] requestWithActionUrlAndParam:url method:HttpRequestPost paramenters:root prepareExecute:^{
                ...
                @try {
                    if(responseModel.rescode == 200){
                        ...
                        strongSelf->slctModel = [MineSkillModel modelWithDict:rspData];
