...
-(void)initVars
{
    ...
    for(int i=0; i<20; i++){
        ...
        NSDictionary *dic = @{
            @"index":@(index),
            @"name":[NSString stringWithFormat:@"培根教育 %ld",index],
            @"location":[NSString stringWithFormat:@"南京 %ld",index],
            @"position":[NSString stringWithFormat:@"员工 %ld",index],
            @"startTime":@"2019-12-19",
            @"endTime":@"2019-12-19",
            @"content":@"培根教育培根教育培根教育培根教育培根教育培根教育培根教育培根教育培根教育培根教育培根教育培根教育",
            @"showLanguage":showLanguage
        };
        
        MineJobModel *model = [MineJobModel modelWithDict:dic];
        [tempArray addObject:model];

    }

    _jobArray = [tempArray copy];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [detailVC setSendValueBlock:^(NSDictionary *valueDict){
        //回调函数
        MineJobModel *modelReturn = valueDict[@"modelReturn"];
        
        slctModel.name = modelReturn.name;
        slctModel.location = modelReturn.location;
        slctModel.position = modelReturn.position;
